...
const phrases = ['Software Engineer', 'CS @ Middlebury College', 'Research Assistant', 'Full-Stack Developer', 'Problem Solver'];
  ...
  return (
    <section id="hero">
      <div className="hero-content">
        ...
        <h1 className="hero-name">Mohammad Abbas</h1>
        <h2 className="hero-title">
          <span ref={typedRef}></span><span className="cursor">|</span>
        </h2>
        <p className="hero-desc">
          Computer Science student at Middlebury College. I build real software, research economic systems,
          and help people work better with technology.
        </p>
        ...
        <div className="hero-socials">
          <a href="https://github.com/mohammadabbas393" target="_blank" rel="noopener" aria-label="GitHub">
          ...
          <a href="https://www.linkedin.com/in/mohammadabbas1594/" target="_blank" rel="noopener" aria-label="LinkedIn">
          ...
          <a href="mailto:mohamadabbas393@gmail.com" aria-label="Email">
